...
function assertUserOwnedGcsUri(gcsUri, uid, allowedPrefixes) {
...
async function handleUploadUrl(req, user) {
    if (req.method !== 'GET') {
...
async function handleDocumentProcess(req, user) {
    if (req.method !== 'POST') {
...
async function generateGeminiJson(prompt, schema, maxOutputTokens = 4096) {
...
async function readUserTextObject(textGcsUri, uid) {
...
function buildAnalysisPrompt(extractedText, fileName, documentTypeHint) {
...
async function handleAiOrchestrate(req, user) {
    if (req.method !== 'POST') {
        throw new HttpError(405, 'METHOD_NOT_ALLOWED', 'Use POST for this endpoint.');
    }
    const body = assertJsonObject(req.body);
...
async function handleAnalysisPersist(req, user) {
    if (req.method !== 'POST') {
        throw new HttpError(405, 'METHOD_NOT_ALLOWED', 'Use POST for this endpoint.');
    }
    const body = assertJsonObject(req.body);
