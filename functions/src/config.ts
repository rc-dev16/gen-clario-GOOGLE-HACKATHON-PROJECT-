...
export function requireUploadBucket(): string {
...
export function requireGeminiLocation(): string {
  return process.env.GEMINI_LOCATION || 'us-central1';
}

export function requireGeminiModel(): string {
  return process.env.GEMINI_MODEL || 'gemini-2.5-flash-lite';
}

export function requireDocumentAiLocation(): string {
  return process.env.DOCUMENT_AI_LOCATION || 'us';
}

export function requireDocumentAiProcessorId(): string {
